...
(sdedr:define-refeval-window "RefWin_1" "Rectangle" (position -0.07 0 0) (position 0.1 -0.05 0))
(sdedr:define-refeval-window "RefWin_2" "Rectangle" (position -0.07 0.6 0) (position 0.1 0 0))

;; Restore GUI session parameters:
(sde:set-window-position 133 379)
