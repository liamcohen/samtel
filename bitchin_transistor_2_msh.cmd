...
Definitions {
	...
	Constant "constant_drain_halo_doping" {
		Species = "BoronActiveConcentration"
		Value = 3e+18
	}
	Constant "constant_drain_ldd_doping" {
		Species = "PhosphorusActiveConcentration"
		Value = 5e+18
	}
	...
	Constant "constant_source_ldd_doping" {
		Species = "PhosphorusActiveConcentration"
		Value = 5e+18
	}
	Constant "constant_source_halo_doping" {
		Species = "BoronActiveConcentration"
		Value = 3e+18
	}
...
Placements {
	...
	Constant "constant_drain_ext_doping_placement_0" {
		Reference = "constant_drain_ext_doping"
		EvaluateWindow {
			Element = region ["drain_n_ext_0"]
		}
	}
	Constant "constant_drain_halo_doping_placement" {
		Reference = "constant_drain_halo_doping"
		EvaluateWindow {
			Element = region ["halo_doped_region_drain"]
		}
	}
	Constant "constant_drain_ldd_doping_placement" {
		Reference = "constant_drain_ldd_doping"
		EvaluateWindow {
	...
	Constant "constant_source_ext_doping_placement_0" {
		Reference = "constant_source_ext_doping"
		EvaluateWindow {
			Element = region ["source_n_ext_0"]
		}
	}
	Constant "constant_source_ldd_doping_placement" {
		Reference = "constant_source_ldd_doping"
		EvaluateWindow {
			Element = region ["source_ldd"]
		}
	}
	Constant "constant_source_halo_doping_placement" {
		Reference = "constant_source_halo_doping"
		EvaluateWindow {
			Element = region ["halo_doped_region_source"]
		}
	}
	...
	Refinement "RefinementPlacement_1" {
		...
		RefineWindow = Rectangle [(-0.07 0) (0.1 -0.05)]
	}
	...
	Multibox "MultiboxPlacement_1" {
		...
		RefineWindow = Rectangle [(-0.07 0) (0.1 0.6)]
	}
}
